...
#define NVIC_ISER0			*((volatile unsigned*)NVIC_BASE + 0x00)
#define NVIC_ISER1			*((volatile unsigned*)NVIC_BASE + 0x04)
#define NVIC_ISER2			*((volatile unsigned*)NVIC_BASE + 0x08)
#define NVIC_ICER0			*((volatile unsigned*)NVIC_BASE + 0x80)
#define NVIC_ICER1			*((volatile unsigned*)NVIC_BASE + 0x84)
#define NVIC_ICER2			*((volatile unsigned*)NVIC_BASE + 0x88)
...
#define NVIC_IRQ23_EXTI5_9_EDisable		(NVIC_ICER0 |= 1<<23)
